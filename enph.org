:PROPERTIES:
:ID:       cf5eb548-54b3-48bf-b231-b29d3b627399
:END:
#+TITLE: enph
* TODO unmerged notes on the [[id:d047ae6a-25c0-4ce4-8617-f3c17d29421a][ENPH]]
* some variables/kinds of data it has
** employment sector
   search for "CIIU"
* refs
** The ENPH
...
******* UNUSED : P9450* : caja de compensación
***** P7040 - ... = second job
...
***** 4 » 4 Supermercados de cajas de compensación, cooperativas, fondos de empleados y comisariatos
...
***** 1 » 1 Almacenes, supermercado de cadena, tiendas por departamento o hipermercados
***** 2 » 4 Supermercados de cajas de compensación, cooperativas, fondos de empleados y comisariatos
...
** Gasto corriente monetario = expenses excluding barter, imputed rent, in-kind income
* seldom used
