...
:END:
#+TITLE: ofiscal, todo
* TODO [[id:9efac453-223b-47c4-8d31-0e5d7702feb9][install python 3.12 in Ubuntu]]
...
* TODO add "it per capita" to tax.co's output
* TODO [[id:fc56bc8f-0aca-4376-bd4f-98e9f69a57ef][tax.co and tax.co.web : document how to run]] (more)
