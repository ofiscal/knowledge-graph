...
** use 2024 prices for all years
** desired shape: year, sector, and type of spending (inversion, funcionamiento, servicio de deuda)
** PITFALL: Entities switch sectors and name over time. Use the classification for the 2024.
* suggest buying a mic and speaker for laptop
* update passwords
* TODO Read Chapter 3 of what Oliver just sent on Whatsapp.
  <2023-10-20 Fri> at 3:02 PM
