...
#+TITLE: ofiscal, todo
* TODO in sim
** TODO see also [[id:dc968fea-dd45-4734-b375-9e60b87005c6][tax.co]]
** TODO add IT to sim, and use it to calculate another VAT / ingresos
...
** TODO compare my total expenses to DANE's magic one
