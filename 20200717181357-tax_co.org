#+title: tax.co
* TODO did I get the vat-for-purchases-only commit right?
Purchase-like taxes such as the predial should not carry it.
...
* TODO possibly wrong
** TODO merge buildings into households, not individuals
This might resolve the mystery of what DANE's aggregate income variables mean.
...
** TODO Why are there fewer infinite values in the full sample?
For the household data, in the 1/10 sample, I see
  vat / purchase value, min   8719.0  0.000000           inf
  vat / purchase value, max   8719.0  0.000000           inf
but in the 1/1 sample, this:
  vat / purchase value, min   87124.0  0.00000  2.129018e-01
  vat / purchase value, max   87124.0  0.00000  2.129038e-01
...
*** TODO to avoid this pitfall in the future
Test each test by first making sure that when it fails, an error is thrown.
