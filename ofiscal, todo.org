...
:END:
#+TITLE: ofiscal, todo
* meeting <2023-06-26 Mon>
  read things in Whatsapp Ofiscal group
* u
** There are now three anexos provided for every bill passed in Congress, itemizing its spending for gender, ethnicity and peacemaking purposes. That data is the basis for Colombia's 3 Trazadores Presupuestales.
** The Plan Nacional de Desarrollo es una ley que dura 4 años, para cada presidente.
...
* Suggest recaps in all team meetings
...
* take any random week, maybe this one (June 7)
* TODO [[id:94e1f993-f2c8-4d0d-9100-ee96abe08f31][modeling a drop in hours required for women to pension]]
