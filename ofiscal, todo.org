...
:END:
#+TITLE: ofiscal, todo
* vulnerability: overpromise
* TODO mention in Lift grant app
** interoperability
** indexing (elasticsearch, etc.)
* TODO for our [[id:64bb1c42-8733-40ce-a37f-a793de9ee58b][Lift grant app to Open Contracting]]
  determine whether we can get the money
  even if we don't submit to some Colombian gov't agency
* TODO look at Open Society reports
  See the four emails called OSF from Oliver,
  and the Whatsapp group called Open Society Reports.
