...
#+TITLE: ofiscal, todo
* TODO today
** Daniel needs micro data from sim with gender and independiente
   Should be all people, not just earners.
*** TODO ? merge household data
** update "cities" for new data
** BLOCKED on Luis Carlos : [[id:0cb6f044-2bdc-44d8-ad73-e9537c4d8846][renew/fix billing for Wix and/or Bluehost]]
* TODO scale money by 10/12
* meeting with Asofondos, <2023-03-24 Fri>
** no cap on TES in the new bill
