...
* TODO what to do about baseline subsample size?
  I'd like to only use recip-1 but that can be slow.
* TODO It's confusing that the baseline gets emailed too.
* TODO run-makefile should rebuild the baseline automatically
