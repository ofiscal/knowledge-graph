...
** our paper on tax.co, in LaTeX, on Overleaf
...
** How is income-percentile defined?
   [jeff@jbb-hp17:~/of/tax.co/online/python]$ grep -i "percentile" -r build --color
** different for nonzero earners than others
** gender split comes after quantile definitions
...
* TODO IMMEDIATE : Inflate from 2017 to 2022
...
* TODO test suite
** TODO [[id:cd0542f8-36de-4f9c-a6a5-2107fa041762][tests and IO]]
...
** Internalize: Baseline config file must match sample size of user config file
   :PROPERTIES:
