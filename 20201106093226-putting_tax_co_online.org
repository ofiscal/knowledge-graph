...
* TODO easy
** rename
*** lock -> lock_for_temp_db
*** at_least_one_is_old -> at_least_one_result_is_old
** [[id:9c7e0481-328c-46ed-82ab-57759d24f8b8][Move all file definitions to dedicated files.py files]].
** Docker: change time zone to COT.
...
** TODO Can I delete the "max_runtime_minutes" parameter?
...
*** TODO incorporate requests/test.py into Makefile
...
*** TODO resubmission problems
    :PROPERTIES:
    :ID:       6d78fc5f-9958-4b28-9ad5-b74e20c7b12a
    :END:
**** TODO If someone resubmits, delete earlier config, but keep earlier submission date.
**** TODO Don't bork if someone resubmits when they already have a completed request.
**** TODO an old completed request should not be able to clobber a new one from the same user
**** TODO add disclaimer to webpage
