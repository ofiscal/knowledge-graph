...
*** TODO NEXT get try-to-advance to work in the repl at /mnt/tax_co
...
**** eventually, will want to call from shell like this
PYTHONPATH=/mnt/tax_co/						       \
  ...
  972411cda1a01ae85f6c36b1b68118c3                                     \
  try-to-advance
*** TODO fix: view currently doesn't trigger add-to-requests
  ...
  /mnt/tax_co/users/972411cda1a01ae85f6c36b1b68118c3/config/shell.json  \
  add-to-queue
*** TODO change os.system calls to subprocess.run calls
