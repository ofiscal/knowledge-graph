...
** TODO serial-ish
*** TODO encode the actual default marginal tax rates
**** BLOCKED Asking: Python version mismatch preventing pandas from loading.
     https://forum.djangoproject.com/t/server-and-shell-using-different-python-versions/9303
**** TODO ? alternative: hard-code the marginal rates into the Javascript
