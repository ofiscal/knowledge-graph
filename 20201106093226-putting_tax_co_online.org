...
* TODO once I have a duration estimate, ask Angelica to call a meeting with everyone, to figure out what we want the interface to be
** study https://github.com/askvortsov1/dynamic-django-forms
   ~/code/dynamic-django-forms
* TODO blocking
...
** [[file:../tech/20210531162655-collect_all_tax_co_and_tax_co_web_paths_in_a_single_repo_file.org][collect all tax.co and tax.co.web paths in a single (repo? file?)]]
