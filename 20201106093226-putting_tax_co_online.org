...
* TODO OVERVIEW serial: web interface, person-level, incorporate DIAN data
* TODO tax.co.web interface
** TODO serial-ish
*** TODO show the default marginal tax rates in the UI
    alternatives
**** TODO from Django, use the `csv` package rather than pandas
***** overview
...
***** TODO steps
****** In JS, populate table fields with arbitrary data from Django.
