...
** TODO why is user 1's getting deleted early?
*** the problem
    When there's space for more than 2 users,
    and 1 has data and 2 does not,
    asking to advance the queue deletes user 1's data.
*** sometimes it doesn't!
    Once that happened, and I had 2 with data and 1 without,
    and still had a request pending for 1,
    advancing generated 1's data without deleting 2's.
** [[id:cd69f027-d73b-4d3d-be8f-bf0a6c7d90e7][test the program (by hand)]]
...
** rename shell.json -> request.json
