...
** [[id:d002eec7-7fe7-4130-8423-88a6408c46ed][run tax.co as a cron job]]
...
** TODO run tax.co as a cron job
   :PROPERTIES:
   :ID:       d002eec7-7fe7-4130-8423-88a6408c46ed
   :END:
*** DONE verify that the command in the script works when entered by hand
*** DONE Do I have to start tax.co.web as root to serve?
    No.
*** TODO should Docker-created files be owned by group "users"?
