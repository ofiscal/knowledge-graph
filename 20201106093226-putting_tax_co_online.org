...
* TODO easy
** [[id:b97325b2-a95c-4c00-9de5-a35429349813][rename /mnt/web -> /mnt/django]]
** [[id:bdafda4f-6fab-46bd-8bbb-f03aee15443c][test email addresses with strange characters]]
** [[id:9c7e0481-328c-46ed-82ab-57759d24f8b8][move all file definitions to dedicated files.py files]]
** [[id:6d78fc5f-9958-4b28-9ad5-b74e20c7b12a][Assume they want the earlier request deleted.]]
** [[id:51d7d5fb-baa0-4558-8bdf-463b6d77f902][bugfix: delete the oldest *extant* user]]
* TODO in tax.co
...
** TODO rename /mnt/web -> /mnt/django
   :PROPERTIES:
   :ID:       b97325b2-a95c-4c00-9de5-a35429349813
   :END:
   find . -name "*.py" -print0 | xargs -0 grep "web" --color
   find . \( -name "*.py" -o -name "*.txt" -o -name "*.sh" -o -name "*.org" -o -name "*.md" -o -name "*.json" -o -name "*.html" -o -name "*.org" \) -print0 | xargs -0 sed -i "s/mnt\/web/mnt\/django/g"
...
** TODO test email addresses with strange characters
   :PROPERTIES:
   :ID:       bdafda4f-6fab-46bd-8bbb-f03aee15443c
   :END:
