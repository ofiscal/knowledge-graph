...
** understand Daniel's spreadsheet
...
** deal with the special restaurant (?) tax
...
*** 0.128 for sugary drinks
    it's now 0.19 ordinary VAT, no other tax applicable
...
** TODO that 0.128 VAT for sugary drinks is obsolete
   it's now 0.19, as of Jan 1 2020
